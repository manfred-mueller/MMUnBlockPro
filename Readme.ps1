Function Create-MMUnblockReadme {
    $Path = "E:\Windows\MMUnBlockPro\README.md"
    $Lines = @(
        '# MMUnblockPro 🚀',
        '',
...
```',
    ...
    Out-File -FilePath $Path -InputObject ($Lines -join "`r`n") -Encoding utf8 -Force
    Write-Host "Perfekt! Die README.md wurde fehlerfrei in E:\Windows\MMUnBlockPro\ generiert." -ForegroundColor Green
}
Create-MMUnblockReadme